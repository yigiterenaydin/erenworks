      ...
      <div className="grid grid-cols-1 md:grid-cols-[220px,1fr] gap-4 items-start">
        ...
        <div className="rounded-lg border border-rose-200/70 dark:border-slate-700/70 bg-white dark:bg-slate-900 p-2 shadow-sm flex justify-center">
          <a href={imageUrl} target="_blank" rel="noopener noreferrer" className="block" aria-label="Bild in neuem Tab öffnen">
            <Image
              src={imageUrl}
              alt="ZKB Schnupperparcours Informatik Nachweis"
              width={420}
              height={280}
        ...
        <div className="space-y-3">
          <div>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white">ZKB – Schnupperparcours Informatik</h2>
            <p className="text-sm text-slate-500 dark:text-slate-400">Einblick in IT‑Ausbildung, Web‑Übungen und Austausch mit Lernenden</p>
          </div>
          <p className="text-sm leading-relaxed text-slate-700 dark:text-slate-200">
            Informatik‑Schnuppertag mit Website‑Übungen (HTML/CSS), Logikaufgaben und Einblick in den
            Lehrablauf. Austausch mit Lernenden, Mitarbeitenden und Personalverantwortlichen.
          </p>
