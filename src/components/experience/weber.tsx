    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-[220px,1fr] gap-4 items-start">
        ...
        <div className="space-y-3">
          <div>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white">E. Weber & Cie AG – Kaufmann EFZ</h2>
            <p className="text-sm text-slate-500 dark:text-slate-400">Vielseitiger Einblick in kaufmännische Abläufe</p>
          </div>
