...
interface DetailCardProps {
  ...
  subtitle?: string;
  imageUrl: string;
  /** When provided, shows a download button */
  docUrl?: string | null;
  /** Main rich description content */
  children: React.ReactNode;
}

/**
 * Reusable experience detail layout.
 * Desktop: 220px thumbnail on the left, content on the right.
