    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-[220px,1fr] gap-4 items-start">
        ...
        <div className="space-y-3">
          <div>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Kornhaus Verwaltungs AG – KV Treuhand / Immobilien</h2>
            <p className="text-sm text-slate-500 dark:text-slate-400">Einblicke in Treuhand‑/Immobilienbereich und kaufmännische Abläufe</p>
          </div>
          <p className="text-sm leading-relaxed text-slate-700 dark:text-slate-200">
            Einblicke in die Tätigkeiten im Treuhand‑ und Immobilienbereich, Kennenlernen kaufmännischer
            Abläufe und Rekrutierungsprozesse; Austausch mit Lernenden und Mitarbeitenden.
          </p>
