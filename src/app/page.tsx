      ...
      <footer className="bg-slate-900 dark:bg-black text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <h4 className="text-2xl font-bold mb-6">Kontakt</h4>
                     ...
                     {[
                       ...
                       <motion.a
                         ...
                         className="w-12 h-12 bg-slate-800 hover:bg-slate-700 rounded-xl flex items-center justify-center transition-all duration-300"
                       >
                         {social.icon}
                       </motion.a>
                     ))}
          ...
          <div className="border-t border-slate-800 mt-12 pt-8 text-center text-slate-400">
            <p>&copy; 2024 Eren Portfolio. Alle Rechte vorbehalten.</p>
          </div>
        </div>
      </footer>
    </AppShell>
